<div style="min-height: 90vh; display: flex; flex-direction: column; justify-content: space-between; text-align: center; font-family: 'Helvetica Neue', Arial, sans-serif; padding: 30px; border: 2px solid #1a365d; box-sizing: border-box;">

  <div style="margin-top: 20px;">
    <p style="font-size: 1.2rem; font-weight: bold; letter-spacing: 2px; color: #2c5282; text-transform: uppercase; margin-bottom: 5px;">
  ...
  <div style="margin: 40px 0;">
    <p style="font-size: 1.1rem; font-weight: 600; color: #4a5568; text-transform: uppercase; letter-spacing: 1px; margin: 0;">
      Curso: Comunicación Asertiva
    </p>
    <hr style="width: 40%; border: 0; border-top: 2px solid #2b6cb0; margin: 20px auto;">
  ...
  <div style="margin-bottom: 20px; text-align: left; padding: 0 8%; font-family: Arial, sans-serif;">
...
# <span style="color:#1a365d;">Índice</span>
...
# <span style="color:#1a365d;">1. Resumen Ejecutivo</span>
...
# <span style="color:#1a365d;">2. Objetivos del Proyecto</span>

## <span style="color:#2b6cb0;">2.1 Objetivo General</span>
...
## <span style="color:#2b6cb0;">2.2 Objetivos Específicos</span>
...
# <span style="color:#1a365d;">3. Desarrollo de la Capacitación</span>
...
## <span style="color:#2b6cb0;">3.1 Distribución del contenido</span>
...
## <span style="color:#2b6cb0;">3.2 Adaptación durante la ejecución</span>
...
## <span style="color:#2b6cb0;">3.3 Participación del público</span>
...
# <span style="color:#1a365d;">4. Autoevaluación mediante FODA</span>

## <span style="color:#2b6cb0;">FODA individual</span>
...
## <span style="color:#2b6cb0;">FODA del grupo</span>
...
# <span style="color:#1a365d;">5. Conclusiones</span>
...
# <span style="color:#1a365d;">6. Anexos</span>

## <span style="color:#2b6cb0;">6.1 Video de organización del equipo</span>

**Plataforma:** YouTube
<a href="https://youtu.be/b4k8EtICcUU">
    <img src="https://i.ytimg.com/vi/b4k8EtICcUU/maxresdefault.jpg"
         alt="Video de planificación del equipo"
         width="80%"
         style="border-radius:12px; box-shadow:0 6px 18px rgba(0,0,0,.25);">
  </a>

---

## <span style="color:#2b6cb0;">6.2 Video de ejecución</span>

**Plataforma:** YouTube
  <a href="https://youtu.be/7tavQcn1TYA?si=90rUghpzCwa4tTao">
    <img src="https://i.ytimg.com/vi/7tavQcn1TYA/maxresdefault.jpg"
...
![Público durante la capacitación](imagenes/publico.jpg)

### Expositores

![Expositores](imagenes/expositores.jpg)

### Dinámica realizada

![Dinámica realizada](imagenes/dinamica.jpg)

## <span style="color:#2b6cb0;">6.4 Tabla de participación del equipo</span>
